...
namespace Kanban.Infrastructure.Repositories.Compromiso;

public class CompromisoRepositorio : BaseRepositorio, ICompromisoRepositorio
{
    public PagedResult<Domain.Genericos.Compromiso.Compromiso> ListarPorPagina(CompromisoFiltro? filtro, int page, int pageSize)
    {
        var _parametros = new List<NpgsqlParameter>();
        var _queryConditions = new StringBuilder();
        List<Domain.Genericos.Compromiso.Compromiso> lista = new();
        var totalRows = 0;
        try
        {
            ...
            using (var cmd = CreateCommand())
            {
                ...
                {
                    while (rd.Read())
                        lista.Add(new Domain.Genericos.Compromiso.Compromiso
                        {
                            Id = rd.GetInt32(0),
            ...
            return new PagedResult<Domain.Genericos.Compromiso.Compromiso>(lista, totalRows, page, pageSize);
        }
        catch (Exception ex)
        {
    ...
    public List<Domain.Genericos.Compromiso.Compromiso> Listar(CompromisoFiltro? filtro)
    {
        var _parametros = new List<NpgsqlParameter>();
        var _queryConditions = new StringBuilder();
        List<Domain.Genericos.Compromiso.Compromiso>? lista = null;
        try
        {
            var _query = new StringBuilder();
            _query.Append(
            ...
            using (var cmd = CreateCommand())
            {
                ...
                using (var rd = cmd.ExecuteReader())
                {
                    lista = new List<Domain.Genericos.Compromiso.Compromiso>();
    ...
    public Domain.Genericos.Compromiso.Compromiso? Buscar(int id)
    {
        Domain.Genericos.Compromiso.Compromiso? entidad = null;
        try
        {
            var _query = new StringBuilder();
            _query.Append(
            ...
            using (var cmd = CreateCommand())
            {
                ...
                {
                    while (rd.Read())
                        entidad = new Domain.Genericos.Compromiso.Compromiso
                        {
                            Id = id,
    ...
    public List<Domain.Genericos.Compromiso.Compromiso> Exportar(CompromisoFiltro filtro)
    {
        var _parametros = new List<NpgsqlParameter>();
    ...
    public bool Guardar(Domain.Genericos.Compromiso.Compromiso entidad)
    {
    ...
    public bool Actualizar(Domain.Genericos.Compromiso.Compromiso entidad)
    {
        ArgumentNullException.ThrowIfNull(entidad.Descripcion);
    ...
    public bool CambiarEstado(Domain.Genericos.Compromiso.Compromiso entidad)
    {
    ...
    public bool Asignar(Domain.Genericos.Compromiso.Compromiso entidad)
    {
        try
        {
            using (var cmd = CreateCommand())
    ...
    public List<Domain.Genericos.Compromiso.Compromiso> IndicadorPorEstado_1_1(int tableroId, DateTime fechaHasta)
    {
        List<Domain.Genericos.Compromiso.Compromiso> lista = new();
        try
        {
    ...
    public List<Domain.Genericos.Compromiso.Compromiso> IndicadorPorEstado_1_2(int tableroId, DateTime fechaDesde, DateTime fechaHasta)
    {
        List<Domain.Genericos.Compromiso.Compromiso> lista = new();
        try
        {
    ...
    public List<Domain.Genericos.Compromiso.Compromiso> PorTablero(int tableroId)
    {
        List<Domain.Genericos.Compromiso.Compromiso> lista = new();
        try
        {
