                    ...
                    if (rd.HasRows)
                    {
                        ...
                        while (rd.Read())
                            lista.Add(new Verificar
                            {
                                ...
                                Verificacion = new Domain.Genericos.Verificaciones.Verificacion { Nombre = rd.GetString(7) },
                ...
                using (var rd = cmd.ExecuteReader())
                {
                    while (rd.Read())
                        lista.Add(new Verificar
                        {
                            ...
                            VP = rd.GetBoolean(4),
                            Verificacion = new Domain.Genericos.Verificaciones.Verificacion
                ...
                using (var rd = cmd.ExecuteReader())
                {
                    while (rd.Read())
                        entidad = new Verificar
                        {
                            ...
                            Verificacion = new Domain.Genericos.Verificaciones.Verificacion { Nombre = rd.GetString(14) },
