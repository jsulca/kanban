...
public class CompromisoLogica(
    ...
    : ICompromisoLogica
{
    public PagedResult<Domain.Genericos.Compromiso.Compromiso> ListarPorPagina(CompromisoFiltro filtro, int page,
        int pageSize)
    {
    ...
    public Domain.Genericos.Compromiso.Compromiso? Buscar(int id, bool conDetalles = false)
    {
    ...
    public void Guardar(Domain.Genericos.Compromiso.Compromiso entidad, int? usuarioId = null, int? empleadoId = null)
    {
    ...
    public void Actualizar(Domain.Genericos.Compromiso.Compromiso entidad)
    {
        transacciones.Ejecutar(() => compromisos.Actualizar(entidad));
    }

    public void CambiarEstado(Domain.Genericos.Compromiso.Compromiso entidad, string? motivo = null,
        int? usuarioId = null,
        int? empleadoId = null)
    {
        transacciones.Ejecutar(() =>
    ...
    public void AsignarAutomatico(Domain.Genericos.Compromiso.Compromiso entidad, int? usuarioId = null,
        int? empleadoId = null)
    {
        transacciones.Ejecutar(() =>
        {
    ...
    public void Asignar(Domain.Genericos.Compromiso.Compromiso entidad, int? usuarioId = null, int? empleadoId = null)
    {
        transacciones.Ejecutar(() =>
        {
    ...
    /// </summary>
    private string DescribirAsignacion(Domain.Genericos.Compromiso.Compromiso entidad, string verbo, DateTime? fecha)
    {
