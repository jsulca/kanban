...
public class VerificacionLogica(
    ...
    : IVerificacionLogica
{
    public PagedResult<Domain.Genericos.Verificaciones.Verificacion> ListarPorPagina(VerificacionFiltro filtro, int page,
        int pageSize)
    {
    ...
    public Domain.Genericos.Verificaciones.Verificacion? Buscar(int id, bool conDetalles = false)
    {
    ...
    public void Guardar(Domain.Genericos.Verificaciones.Verificacion entidad)
    {
